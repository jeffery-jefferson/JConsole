...
public class CommandStringMap implements IJCommandStringMap 
{
    ...
    public Collection<IJCommand> GetCommands() 
        throws Exception 
    {
        return this._commands.values();
    }

    public void TryAddCommand(IJCommand command) 
        throws Exception 
    {
    ...
    public void TryRemoveCommand(IJCommand command) 
        throws Exception 
    {
        if (!this._commands.containsKey(command.GetCommandName())) 
        {
    ...
    public IJCommand TryGetCommandByName(String commandName) 
        throws Exception 
    {
